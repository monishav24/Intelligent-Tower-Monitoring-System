...
from services.algorithm_comparison_service import AlgorithmComparisonService
from routes.api import api_bp, init_api_service
from routes.comparison_routes import comparison_bp, init_comparison_routes
...
# Instantiate parallel algorithm comparison service
comparison_service = AlgorithmComparisonService()
init_comparison_routes(comparison_service)
...
if __name__ == "__main__":
    ...
    # Start parallel algorithm comparison daemon thread
    comparison_service.start()
    ...
    print("   ML Comparison Module: ACTIVE (/api/model-comparison)                 ")
    print("========================================================================\n")
